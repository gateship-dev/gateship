...
export const AGENT_OPERATIONS: Readonly<Record<string, AgentOperation>> = {
	...
	'issues.create': { method: 'POST', path: projectPath('/issues'), input: '{projectId, title, objective, acceptance, boundaries?, verify, evidence?, research?}' },
	'issues.create_approved': { method: 'POST', path: projectPath('/issues/create-approved'), input: '{projectId, title, objective, acceptance, boundaries?, verify, evidence?, research?, authorization}' },
	'issues.specify': { method: 'POST', path: issuePath('/spec'), input: '{projectId, issueId, objective, acceptance, boundaries?, verify, evidence?, research?}' },
