...
| Data surfaces share one text inset, 16px: a `Stat`, and the first and last cell of a table. Between columns a table keeps 12px. A card, which holds prose and forms, keeps 24px | Visual gate baselines |
