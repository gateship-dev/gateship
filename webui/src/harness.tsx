...
const ATTENTION_PROJECT = { ...PROJECT, id: 'harness-project-attention', name: 'Gateship fixture attention', repository: 'fixture/gateship-attention', current: false };
...
const DENSE_QUEUES: QueueOverviewView = { queues: [
	{ ...QUEUES.queues[0]!, project: PROJECT, currentIssue: { id: 'GSHIP-861', title: 'First ordered queue item' }, plannedIssues: [{ id: 'GSHIP-861', title: 'First ordered queue item' }, { id: 'GSHIP-862', title: 'Second ordered queue item' }] },
	{ ...QUEUES.queues[0]!, project: SECOND_PROJECT, currentIssue: null, plannedIssues: [] },
...
function queueResponse(json: (body: unknown) => Response): Response | Promise<Response> {
	...
	if (harnessScenario === 'dense') return json(DENSE_QUEUES);
