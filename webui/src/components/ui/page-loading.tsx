...
//
// A page that has nothing to show yet shows the mark, drawing its arch over
// and over, and says what it waits for. A skeleton is for a block inside a
...
export function LoadingMark({ className }: { className?: string }): React.ReactElement {
	return <span aria-hidden="true" className={cn('loading-mark block text-foreground', className)} data-slot="loading-mark"><GateshipMark className="size-10" /></span>;
}
