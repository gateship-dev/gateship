...
export interface OverviewInsightsCatalog {
	...
	dispatchToMerge: string; reviewRounds: string; operatorInterventions: string; resolvedQuestions: string; providerHolds: string; ciCorrections: string; costCoverage: string; knownCost: string; apiEquivalent: string; subscriptionSeparate: string; tokens: string; inputTokens: string; outputTokens: string; configurations: string; noComparison: string; unavailable: string; noData: string;
	cohorts: string; cohortEvidenceInsufficient: string; workflowRevision: string; specVersion: string; sample: string; outcomeCounts: string; corrections: string; cycleQuestions: string; reconciliations: string; attentionRequests: string; cohortOperatorInterventions: string; cohortProviderHolds: string; cohortLegend: string;
