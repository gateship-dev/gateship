...
export interface OverviewRunsCatalog {
	...
	run: string; date: string; time: string; roles: { orchestrator: string; executor: string; reviewer: string };
