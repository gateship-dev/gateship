...
export interface RunInspectorCatalog {
	...
	specFacts: {
		...
		dispatchCounts: (executor: number, reviewer: number, orchestrator: number, total: number) => string;
