...
export interface OverviewCatalog {
	title: string;
	description: string;
	navigation: { label: string; now: string; runs: string; queues: string };
	loading: string;
	empty: string;
	partial: string;
	error: string;
