...
export interface OverviewCatalog {
	...
	queues: { title: string; description: string; loading: string; error: string; empty: string; unavailable: string; readiness: string; chain: string; enabled: string; disabled: string; paused: string; current: string; next: string; planned: string; none: string };
}
...
export const LOCALE_CATALOG = {
	'en-US': {
		...
		overview: {
			title: 'Control center', description: 'A live view of project readiness, active work and recent outcomes.', navigation: { label: 'Control center', now: 'Now', runs: 'Runs' }, loading: 'Loading operational overview…', empty: 'No projects are registered yet.', partial: 'Some project data is unavailable.', error: 'The operational overview could not be loaded.', queues: { title: 'Queues', description: 'Deterministic approved work by project.', loading: 'Loading queues…', error: 'Queues could not be loaded.', empty: 'No projects are registered yet.', unavailable: 'Project queue is unavailable.', readiness: 'Readiness', chain: 'Chain', enabled: 'enabled', disabled: 'disabled', paused: 'paused', current: 'Current', next: 'Next admissible', planned: 'Planned issues', none: 'None' },
	...
	'pt-BR': {
		...
		overview: {
			title: 'Central de controle', description: 'Visão ao vivo da prontidão, do trabalho ativo e dos resultados recentes dos projetos.', navigation: { label: 'Central de controle', now: 'Agora', runs: 'Execuções' }, loading: 'Carregando visão operacional…', empty: 'Nenhum projeto foi registrado ainda.', partial: 'Alguns dados de projetos estão indisponíveis.', error: 'Não foi possível carregar a visão operacional.', queues: { title: 'Filas', description: 'Trabalho aprovado e determinístico por projeto.', loading: 'Carregando filas…', error: 'Não foi possível carregar as filas.', empty: 'Nenhum projeto foi registrado ainda.', unavailable: 'A fila do projeto está indisponível.', readiness: 'Prontidão', chain: 'Encadeamento', enabled: 'ligado', disabled: 'desligado', paused: 'pausado', current: 'Atual', next: 'Próxima admissível', planned: 'Issues planejadas', none: 'Nenhuma' },
